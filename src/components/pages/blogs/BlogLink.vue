...
<template>
      <div
      class="d-flex justify-content-between align-items-center blog-link" :class="className"
    >
      <div class="blog-link__content">
        <router-link :to="link" class="blog-link__content__text textL">
          {{linkText}}
        </router-link>
      </div>
      <router-link :to="link" class="blog-link__image">
        <svg
