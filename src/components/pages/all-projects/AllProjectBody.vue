...
<template>
  <div class="m-t-60px">
    <div class="all-project-body">
      <div class="all-project__1st-row">
        <div class="all-project__1st-row-1st-column">
          <AllProjectImage :image="image11" :width="636" :hight="320" />
          <AllProjectImage :image="image12" :width="636" :hight="320" />
        </div>
        <div class="all-project__1st-row-2nd-column">
          <AllProjectImage :image="image13" :width="636" :hight="664" />
        </div>
      </div>
      <div class="all-project__2nd-row">
        <AllProjectImage :image="image21" :width="1296" :hight="400" />
      </div>
      <div class="all-project__3rd-row">
        <div class="all-project__3rd-row-1st-column">
          <AllProjectImage :image="image31" :width="636" :hight="393" />
        </div>
        <div class="all-project__3rd-row-2nd-column">
